      ...
      <div className="w-full max-w-md space-y-6 rounded-xl border border-hacman-gray bg-hacman-dark p-8 shadow-2xl shadow-black/50">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-white px-4 py-2.5 font-semibold text-gray-700 hover:bg-gray-100 transition-colors"
          >
        ...
        <p className="text-center text-sm text-hacman-muted">
          New here? Just click one of the buttons above to create an account.
        </p>
        ...
        {/* Warning notice */}
        <div className="flex gap-2 rounded-lg border border-amber-500/30 bg-amber-500/10 p-3" role="note">
          <svg className="mt-0.5 h-4 w-4 shrink-0 text-amber-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" aria-hidden="true">
